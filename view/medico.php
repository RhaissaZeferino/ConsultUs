        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="col-md-6">
                        ...
                        <table class="table">
                            ...
                            <?php
                                if(isset($_SESSION['login'])){     
                                    ...
                                    $sql = "SELECT c.especialidade, c.hora, c.data, p.nome as 'p_nome' from consulta as c
                                    JOIN usuario as p ON c.CPF_paciente= p.id_user
                                    where c.CRM_med = '$id_logado' and c.CPF_paciente = p.id_user and c.data = CURRENT_DATE()";
                    ...
                    <div class="col-md-6" style="border-left: 5px double #2299aa;">
                        ...
                        <table class="table">
                            ...
                            <?php
                                if(isset($_SESSION['login'])){     
                                    ...
                                    $sql = "SELECT c.especialidade, c.hora, c.data, p.nome as 'p_nome' from consulta as c
                                    JOIN usuario as p ON c.CPF_paciente= p.id_user
                                    where c.CRM_med = '$id_logado' and c.CPF_paciente = p.id_user";
                                    $result = mysqli_query($conexao, $sql);
                                }
                                    while($row = mysqli_fetch_array($result)){
                                ?>
